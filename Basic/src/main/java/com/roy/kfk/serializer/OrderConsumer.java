...
public class OrderConsumer {
    ...
    public static void main(String[] args) {
        ...
        //value序列化类
        props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, "com.roy.kfk.serializer.OrderDeserializer");
...
//        consumer.seekToBeginning();
        while (true) {
            //PART2:拉取消息
            // 100毫秒超时时间
            ConsumerRecords<String, Order> records = consumer.poll(Duration.ofNanos(100));
            //PART3:处理消息
